(function ( $ ) {
	...
	$.fn.StandardFixedStartMixedModeRouteOptionsBuilder = function StandardFixedStartMixedModeRouteOptionsBuilder(options) {
	...
	$.fn.StandardFixedStartMixedModeRouteOptionsBuilder.prototype = {
		setOrigin: function(){
