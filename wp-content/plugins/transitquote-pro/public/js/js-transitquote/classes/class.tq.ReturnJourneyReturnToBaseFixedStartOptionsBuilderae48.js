(function ( $ ) {
	...
	$.fn.ReturnJourneyReturnToBaseFixedStartOptionsBuilder = function ReturnJourneyReturnToBaseFixedStartOptionsBuilder(options) {
	...
	$.fn.ReturnJourneyReturnToBaseFixedStartOptionsBuilder.prototype = {
		setOrigin: function(){
		...
		setWaypoints: function(){
			var waypoints = this.settings.routeAddressPickers.getWaypointLocationsReturnJourneyReturnToBaseFixedStart();
